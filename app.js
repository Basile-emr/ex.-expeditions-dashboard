...
window.addEventListener('DOMContentLoaded', ()=>{
  ...
  document.getElementById('resetBtn').addEventListener('click', ()=>{ for (const id of ['semaineSelect','materielSelect','ipoSelect']){ const el = document.getElementById(id); for (const o of el.options) o.selected = false; } renderAll(); });
